...
void init_Params() {
	...
	params[2].pow_turn_90.offset_dist_in = 68;
	params[2].pow_turn_90.offset_dist_out = 68;
	...
	params[3].pow_turn_180.offset_dist_out = 101;
	...
	params[3].pow_turn_90.offset_dist_in = 68;
	params[3].pow_turn_90.offset_dist_out = 68;
